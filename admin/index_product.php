          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-3">
                  <a class="btn btn-info" href="create_product.php">Add New Product</a>
                </div>
              </div>
            </div>
            <div class="card-body">
              <table class="table table-hover table-striped" id="dataTable">
                <thead>
                  <tr>
                    ...
                    <th width="5%" style="text-align: center; border-right: 1px solid #FFF;">Product Code</th>
                    <th width="50%" style="text-align: center; border-right: 1px solid #FFF;">Product Title</th>
                    <th width="5%" style="text-align: center; border-right: 1px solid #FFF;">Price</th>
                    <th width="5%" style="text-align: center; border-right: 1px solid #FFF;">Quantity</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td style="text-align: center; border-right: 1px solid #FFF;">#PLE20</td>
                    <td style="text-align: center; border-right: 1px solid #FFF;">Hp Probook</td>
                    <td style="text-align: center; border-right: 1px solid #FFF;">50000</td>
                    <td style="text-align: center; border-right: 1px solid #FFF;">10</td>
                    <td style="text-align: center; border-right: 1px solid #FFF;">
                      <a href="edit_product.php" class="btn btn-success">Edit</a>
