          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-3">
                  <a class="btn btn-info" href="create_brand.php">Add New Brand</a>
                </div>
              </div>
            </div>
            <div class="card-body">
              <table class="table table-hover table-striped" id="dataTable">
                ...
                <thead>
                  <tr>
                    ...
                    <th width="30%" style="text-align: center; border-right: 1px solid #FFF;">Brand Name</th>
                    <th width="30%" style="text-align: center; border-right: 1px solid #FFF;">Brand Image</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="text-align: center; border-right: 1px solid #FFF;">Sony</td>
                    <td style="text-align: center; border-right: 1px solid #FFF;">
                      <img src="images/sony.png" width="35">
                    </td>

                    <td style="text-align: center; border-right: 1px solid #FFF;">
                      <a href="edit_brand.php" class="btn btn-success">Edit</a>
